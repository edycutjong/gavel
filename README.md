...
| **2026-09-09** | The README said **50 executions** in four places, and **80 tests** in four more | 150 and 87. The data was regenerated and the prose was not — twice in one day, then a third time when rostering four Safes took the opt-in list from five to nine and the README still said five | [`0c3ccfc`](../../commit/0c3ccfc), [`88bb3d2`](../../commit/88bb3d2) |
